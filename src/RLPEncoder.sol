 ...
 * @author Bakaoh
 * @notice The original code can be found at https://github.com/bakaoh/solidity-rlp-encode/blob/1fcf14f4e1c6f0eeaa9a87f0c06f8c5b4243e21d/contracts/RLPEncode.sol
 */
library RLPEncoder {
    /*
     * Internal functions
     ...
     */
    function encode(bytes memory self) internal pure returns (bytes memory) {
     ...
     * @return The RLP encoded string in bytes.
     */
    function encode(string memory self) internal pure returns (bytes memory) {
        return encode(bytes(self));
    }
     ...
     */
    function encode(address self) internal pure returns (bytes memory) {
